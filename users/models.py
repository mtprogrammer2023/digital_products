...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, username, phone_number, email, password, is_staff, is_superuser, **extra_fields):
        ...
        # Creates and saves a BaseUserManager with the given username, email and password
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # admin-comliant permissions.
    #
    # Username, password and email are required. Other fields are optional.

    username = models.CharField(_('username'), max_length=32, unique=True,
                                help_text=_('Required. 30 characters or fewer startig with a letter. letters, digital'),
                                validators=[
...
class UserProfile(models.Model):
    ...
    # email = models.EmailField(_('emaill address'), blank=True)
